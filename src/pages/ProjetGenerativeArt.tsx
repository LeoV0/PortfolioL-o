      ...
      <div className="max-w-4xl mx-auto space-y-32 pb-32">
        ...
        >
          ...
          <p className="text-sm md:text-base text-neutral-600 max-w-xl mx-auto">
            Exploring the Canvas API as a medium for visual expression using
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <a
                ...
                onClick={() =>
                  portfolioEvents.clickExternalLink(
                    ...
                    "https://generative-art-landing-page.vercel.app/",
                  )
                }
              ...
              <a
                ...
                onClick={() =>
                  portfolioEvents.clickExternalLink(
                    "Generative Art GitHub",
                    "https://github.com/LeoV0/Generative-Art",
                  )
                }
                className="block text-neutral-700 hover:text-neutral-900 transition-colors"
              >
        ...
        <div className="grid md:grid-cols-2 gap-16">
          <div className="space-y-4">
            ...
            <p className="text-neutral-700 leading-loose">
              This project was born out of a desire to explore the Canvas API as
              a medium for visual expression, using code to compose a piece of
              generative art. The interface is inspired by architectural plans
          ...
          <div className="space-y-4">
            ...
            <p className="text-neutral-700 leading-loose">
              I used the Canvas API to create animated backgrounds with moving
              blue squares and variations in the center of the scene. The React
              page is designed like an editorial poster with large hero visuals,
              calm typography and smooth animations.
            </p>
          </div>
        </div>
        ...
        <blockquote className="border-l-2 border-neutral-300 pl-8 py-4">
          <p className="text-2xl md:text-3xl font-light text-neutral-800 leading-relaxed italic">
            "Code becomes a brush, randomness becomes intention, and the canvas
